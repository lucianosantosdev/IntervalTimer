...
import dev.lucianosantos.intervaltimer.mobile.databinding.FragmentTimerFinishedBinding
...
class TimerFinishedFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.backToBeginButton.setOnClickListener {
            findNavController().navigate(R.id.action_timerFinishedFragment_to_settingsFragment)
        }
